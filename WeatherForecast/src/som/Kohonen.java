...
public class Kohonen extends Training implements Validation {
	 ...
	 *Trains the neural network by
		applying the Kohonen algorithm.
	...
	/*
	 * Initializes listOfWeightOut of the
		list of neurons from the input layer
		with zero and Returns: NeuralNet object with the
	 ...
	 * Calculates the Euclidian distance
		...
		Returns: List of real values with
		Euclidian distances
	 */
	...
	/*
	 * Adjusts weights of the winner
		neuron (on the basis of the Euclidian distance list)
