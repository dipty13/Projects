...
public class HiddenLayer extends Layer {
	...
	/*
	 * Initializes the hidden layers with pseudo
		random real numbers
		parameters are-An object of the HiddenLayer
		class, a list of objects of the HiddenLayer class,
		an object of the InputLayer class, an object of
	...
	/*
	 * Prints the weights of the layers
	 * parameter is-A list of objects of the
		HiddenLayer class
	 */
