...
public class Backpropagation extends Training {
	...
	/*
	 *Trains the neural network using the
		backpropagation algorithm. This method
		overrides the method from the Training
		class and returns NeuralNet object (neural net
	...
	/*
	 * Performs the propagation of the signal from
		the first layer to the hidden layer and to the
		output layer
	 */
	...
	/*
	 * Performs the retro-propagation of the signal
		from the output layer to the hidden layer
		and to the first layer. In this method, the
